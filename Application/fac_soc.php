...
<script type="text/javascript" src="jscal/onChangesoc.js"></script>
        <style type="text/css">
...
<td width="129" height="45"></td>
                <td width="200" ></td>
                <td width="160" height="45"><strong>Choix une societe :</strong></td>
            <td width="150">
            <select name='societe' id='societe' onchange="go()">
                  <option value='-1'>-- Choisissez une sociète --</option>
                  <?php
						connect();
						$res = mysql_query("SELECT * FROM societe ORDER BY raisonsocial");

...
$id=$_GET['id'];
connect();
$result=mysql_query("SELECT * FROM payementsoc WHERE id_facture='$id';");
...
connect();
$res="UPDATE facture_s set active=0 WHERE id_facture='$id'";
...
<div class="post">
				<h2 class="title">suppression d'une facture</h2>
				<div class="entry">
                
     <p align="center"> vous etes sur le point de supprimer une facture<br />
     Etes - vous d'accord ?
     <?php $ref='delfsoc.php?id=".$id."'; ?>

...
connect();
$res="DELETE FROM pseudo WHERE id_pseudo='$id'";

mysql_query($res) or die('Erreur de connection a la base de donner');
	
	
echo"<script>alert(' L'utilisateur  a ete supprimer avec succes ')</script>";

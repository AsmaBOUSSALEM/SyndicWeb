...
connect();
$res="UPDATE payementpro set active=0 WHERE id_payement='$id'";

mysql_query($res) or die('erreur de connection a la base donner');
	
	
echo"<script>alert(' La reglement  a ete supprimer avec succes ')</script>";
...
<div class="post">
				<h2 class="title">suppression d'un reglement</h2>
				<div class="entry">
                
     <p align="center"> vous etes sur le point de supprimer un reglement<br />
     Etes - vous d'accord ?
     <?php $ref='delppro.php?id=".$id."'; ?>

...
<?php
	...
	if(isset($_POST["id_apartement"]) and $_POST["id_apartement"]!=""){
...
//$montant=$row4['montant'];
		...
		$res = mysql_query("SELECT * FROM proprietaire 
			WHERE  id_apartement=".$_POST["id_apartement"]." ");
...
where id_apartement='$numApart' and active=1;" ) ;
$result5 = mysql_query($recherche5);
$row5 = mysql_fetch_array($result5);
$count=$row5[0];
$total=$row5[0];
$recherche5 = ("SELECT ROUND(SUM(montantPayer),1) FROM payementPro where active=1
